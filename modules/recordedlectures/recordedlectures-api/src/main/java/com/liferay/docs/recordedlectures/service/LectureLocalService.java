...
public interface LectureLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.docs.recordedlectures.service.impl.LectureLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the lecture local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link LectureLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Lecture createLecture(long recordedlectureId);
	...
	public Lecture deleteLecture(Lecture lecture) throws PortalException;
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Lecture deleteLecture(long recordedlectureId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Lecture fetchLecture(long recordedlectureId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public Lecture getLecture(long recordedlectureId) throws PortalException;
