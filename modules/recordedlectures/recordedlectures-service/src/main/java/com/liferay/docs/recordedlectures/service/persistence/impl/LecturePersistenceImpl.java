...
import com.liferay.docs.recordedlectures.service.persistence.LectureUtil;
...
public class LecturePersistenceImpl
	...
	public Lecture[] findByUuid_PrevAndNext(
		...
		Lecture lecture = findByPrimaryKey(recordedlectureId);
	 ...
	 */
	@Override
	public List<Lecture> findByGroupId(long groupId) {
	 ...
	 */
	@Override
	public List<Lecture> findByGroupId(long groupId, int start, int end) {
	 ...
	 */
	@Override
	public List<Lecture> findByGroupId(
	...
	public Lecture findByGroupId_First(
		...
		Lecture lecture = fetchByGroupId_First(groupId, orderByComparator);
	...
	public Lecture fetchByGroupId_First(
		...
		List<Lecture> list = findByGroupId(groupId, 0, 1, orderByComparator);
	...
	public Lecture findByGroupId_Last(
		...
		Lecture lecture = fetchByGroupId_Last(groupId, orderByComparator);
	...
	public Lecture fetchByGroupId_Last(
		...
		List<Lecture> list = findByGroupId(
	...
	public Lecture[] findByGroupId_PrevAndNext(
		...
		try {
			...
			array[0] = getByGroupId_PrevAndNext(
				session, lecture, groupId, orderByComparator, true);

			array[1] = lecture;

			array[2] = getByGroupId_PrevAndNext(
				session, lecture, groupId, orderByComparator, false);
	...
	protected Lecture getByGroupId_PrevAndNext(
		Session session, Lecture lecture, long groupId,
		OrderByComparator<Lecture> orderByComparator, boolean previous) {
	...
	public Lecture create(long recordedlectureId) {
		...
		lecture.setNew(true);
		lecture.setPrimaryKey(recordedlectureId);
	 ...
	 */
	@Override
	public Lecture remove(long recordedlectureId)
		throws NoSuchLectureException {

		return remove((Serializable)recordedlectureId);
	}
	...
	public Lecture findByPrimaryKey(long recordedlectureId)
		...
		return findByPrimaryKey((Serializable)recordedlectureId);
	}
	...
	public Lecture fetchByPrimaryKey(long recordedlectureId) {
		return fetchByPrimaryKey((Serializable)recordedlectureId);
	}
